            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div
                    ...
                    <div class="relative group">
                        ...
                        <!-- Quick View Overlay -->
                        <div
                            class="absolute inset-0 bg-slate-400/0 group-hover:bg-slate-400/50 opacity-0 group-hover:opacity-100 transition duration-300 flex items-center justify-center">
                        ...
                        @if ($product->created_at->diffInDays(now()) <= 7) <div class="absolute top-4 left-4">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap gap-4">
            ...
            <a href="#category-{{ $category->slug }}"
                ...
                onclick="document.querySelector('h2:contains(\"
                {{ $category->name }}\")').scrollIntoView({behavior: 'smooth' })">
