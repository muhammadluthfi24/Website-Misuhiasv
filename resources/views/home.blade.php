...
<div class="relative">
    ...
    <img src="/images/hero.png" alt="Banner Kaos" class="w-full h-96 object-cover">
</div>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center">
                <div
                    class="bg-slate-900 text-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
